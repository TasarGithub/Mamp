<img class="brand_logo" src="/public/images/wilson.jpg" />
          <p>У нас вы можете арендовать дизельный генератор (ДГУ) Wilson P 135 по разумной цене на срок от 3 дней до нескольких месяцев. Мы доставляем технику по Москве и области 24 часа в сутки. Если электростанция выходит из строя – бесплатно заменяем ее в течение суток.</p>
<br />

<div class="item_col_1">
    <img class="img-responsive" src="/public/images/catalog/p135.jpg" alt="Wilson P135 " title="Wilson P135" /><br />
...
<div class="item_col_2">
    ...
    <table class="char_table">
            ...
            <td>136 кВА / 109 кВт</td>
        </tr>
        
                <tr>
            <td>Резервная мощность</td>
            <td>149 кВА / 119 кВт</td>
        </tr>
...
<p>Чтобы ознакомиться с инструкцией к Wilson P135, посмотреть сертификаты и другие документы на генератор, свяжитесь с нами по телефону <?php echo $GLOBALS['phone']; ?>.</p>
<p>Специалист ответит на любые ваши вопросы, а при необходимости составит смету аренды и направит ее на электронную почту. Также вы можете запросить расчет аренды прямо на сайте, заполнив форму обратной связи.</p>
