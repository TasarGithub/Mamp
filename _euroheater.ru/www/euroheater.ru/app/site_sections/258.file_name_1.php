<img class="brand_logo" src="/public/images/atlasсopco.jpg" />
             <p>Предлагаем аренду электростанции Atlas Copco QAS 325 и несем полную ответственность за ее доставку и подключение. Все наши обязательства прописываем в договоре. Там же указываем фиксированную цену на прокат.</p>
<br />

<div class="item_col_1">
    <img class="img-responsive" src="/public/images/catalog/qas325.jpg" alt="Atlas Copco QAS 325" title="Atlas Copco QAS 325" /><br />
...
<div class="item_col_2">
    ...
    <table class="char_table">
            ...
            <td>328 кВА / 263 кВт</td>
        </tr>
        
                <tr>
            <td>Резервная мощность</td>
            <td>360 кВА / 289 кВт</td>
        </tr>
...
<td></td>
    ...
    <tr>
<td>от 1950 руб./час</td>
<td>от 330 руб./час</td>
<td>от 7500 руб./сутки</td>
...
<p>Все станции круглосуточно обслуживаются нашими операторами. Специалист обеспечит стабильную работу генератора и быстро исправит неполадки. Если устранить поломку не получится, бесплатно заменим станцию на аналогичную в течение 24 часов.</p>
<br />
