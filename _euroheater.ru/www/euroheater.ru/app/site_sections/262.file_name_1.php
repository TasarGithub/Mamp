<img class="brand_logo" src="/public/images/fubag.jpg" />
              <p>Предлагаем в аренду дизель генератор Fubag DS 20000 в шумозащитном кожухе с доставкой в любую точку Москвы и области. Оформляем прокат на срок от нескольких дней.</p>
<p>На длительную аренду даем скидки. Для резервной аренды предлагаем сниженные тарифы. Если необходима срочная подача станции, привезем ее на следующий день после заказа.</p>
<br />

<div class="item_col_1">
    <img class="img-responsive" src="/public/images/fubag-13kvt.jpg" alt="Fubag DS 15000" title="Fubag DS 20000 DAC ES SILENT " /><br />
...
<div class="item_col_2">
    ...
    <table class="char_table">
            ...
            <td>17 кВА / 13,6 кВт</td>
        </tr>
        
                <tr>
            <td>Резервная мощность</td>
            <td>18,5 кВА / 14,5 кВт</td>
        </tr>
...
<p>Чтобы уточнить условия аренды, ознакомиться с сертификатами на генератор и получить скидку, обратитесь к нашим операторам: <?php echo $GLOBALS['phone']; ?>.</p>
<br />
